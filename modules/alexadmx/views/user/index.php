            ...
            [
                ...
                'value' => function($model)
                {
                    ...
                    if($model->role != User::ROLE_ADMIN){ // кроме админа
                        if ($model->status == 1){
                            $btn .= '<br><a href="/alexadmx/user/set-deleted?id=' . $model->id . '" class="btn btn-danger" style="transform: scale(.8);text-wrap: none">удаленным</a>
                                    <br><a href="/alexadmx/user/set-active?id=' . $model->id . '" class="btn btn-success" style="transform: scale(.8);text-wrap: none">активным</a>';
                        }elseif ($model->status == 0){
                            $btn .= '<br><a href="/alexadmx/user/set-active?id=' . $model->id . '" class="btn btn-success" style="transform: scale(.8);text-wrap: none">активным</a>';
